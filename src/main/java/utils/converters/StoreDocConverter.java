...
public class StoreDocConverter {
    public static Docs convertToStorageDoc(int flag, DocsFX docsFX){
        Docs docs = null;
        switch (flag){
            case 0:
        ...
        docs.setCost(docsFX.getCost());

        docs.setRelatedDoc(docsFX.getRelatedDoc());
        return docs;
    }

    public static DocsFX convertToStorageDocFX(Docs docs){
